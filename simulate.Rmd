...
These are the values we'll use in the simulation. With the square root of the sum of all the variance components equal to `r round(denom, 2)`, a Cohen's d-like value of 0.30 would be `0.65*0.3 = 0.195`
