...
If we go with the estimates of the lower 95% confidence interval for random effects from the small pilot trial, the required sample size goes down a good bit. Now we're in the ballpark of d=0.3 with just north of 120 families (60 treated) before considering attrition.
